...
model = keras.models.load_model(r"C:\Users\calvin\Downloads\UWI\Year 3\Semester 2\CSTONE\Appearance\Produce-Grader\ImageClassifier\pretrained_model.h5") 
...
def predictor(img_path, loop, crop_width_height):
    ...
    try:
        ...
        if np.max(prediction) < threshold:
            print("The image is not close to what the model has been trained on.")
        else:
